//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (d6084cd1) on 2021-06-10 14:20:23
//--------------------------------------------------------------------------------
module top(
	input wire sys_clk,
	input wire sys_rst,
...
wire main_fields_i_gpio_0;
wire main_fields_i_gpio_1;
wire main_fields_oe_gpio_0;
wire main_fields_oe_gpio_1;
wire main_fields_o_gpio_0;
wire main_fields_o_gpio_1;
reg [1:0] main_i_status = 2'd0;
wire main_i_we;
reg main_i_re = 1'd0;
reg [1:0] main_oe_storage = 2'd0;
reg main_oe_re = 1'd0;
reg [1:0] main_o_storage = 2'd0;
reg main_o_re = 1'd0;
...
reg [19:0] main_motiongeneratoraxis_speed = 20'd0;
...
reg builder_csrbank2_i_re = 1'd0;
wire [1:0] builder_csrbank2_i_r;
reg builder_csrbank2_i_we = 1'd0;
wire [1:0] builder_csrbank2_i_w;
reg builder_csrbank2_oe0_re = 1'd0;
wire [1:0] builder_csrbank2_oe0_r;
reg builder_csrbank2_oe0_we = 1'd0;
wire [1:0] builder_csrbank2_oe0_w;
reg builder_csrbank2_o0_re = 1'd0;
wire [1:0] builder_csrbank2_o0_r;
reg builder_csrbank2_o0_we = 1'd0;
wire [1:0] builder_csrbank2_o0_w;
...
reg builder_csrbank3_enable0_re = 1'd0;
wire builder_csrbank3_enable0_r;
reg builder_csrbank3_enable0_we = 1'd0;
wire builder_csrbank3_enable0_w;
reg builder_csrbank3_width0_re = 1'd0;
wire [31:0] builder_csrbank3_width0_r;
reg builder_csrbank3_width0_we = 1'd0;
wire [31:0] builder_csrbank3_width0_w;
reg builder_csrbank3_period0_re = 1'd0;
wire [31:0] builder_csrbank3_period0_r;
reg builder_csrbank3_period0_we = 1'd0;
wire [31:0] builder_csrbank3_period0_w;
...
assign main_tstriple0_oe = main_fields_oe_gpio_0;
assign main_tstriple0_o = main_fields_o_gpio_0;
assign main_fields_i_gpio_0 = main_tstriple0_i;
assign main_tstriple1_oe = main_fields_oe_gpio_1;
assign main_tstriple1_o = main_fields_o_gpio_1;
assign main_fields_i_gpio_1 = main_tstriple1_i;
...
assign builder_csrbank2_i_r = builder_interface2_bank_bus_dat_w[1:0];
always @(*) begin
	builder_csrbank2_i_re <= 1'd0;
	builder_csrbank2_i_we <= 1'd0;
	if ((builder_csrbank2_sel & (builder_interface2_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank2_i_re <= builder_interface2_bank_bus_we;
		builder_csrbank2_i_we <= (~builder_interface2_bank_bus_we);
	end
end
assign builder_csrbank2_oe0_r = builder_interface2_bank_bus_dat_w[1:0];
always @(*) begin
	builder_csrbank2_oe0_we <= 1'd0;
	builder_csrbank2_oe0_re <= 1'd0;
	if ((builder_csrbank2_sel & (builder_interface2_bank_bus_adr[8:0] == 1'd1))) begin
		builder_csrbank2_oe0_re <= builder_interface2_bank_bus_we;
		builder_csrbank2_oe0_we <= (~builder_interface2_bank_bus_we);
	end
end
assign builder_csrbank2_o0_r = builder_interface2_bank_bus_dat_w[1:0];
always @(*) begin
	builder_csrbank2_o0_we <= 1'd0;
	builder_csrbank2_o0_re <= 1'd0;
	if ((builder_csrbank2_sel & (builder_interface2_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csrbank2_o0_re <= builder_interface2_bank_bus_we;
		builder_csrbank2_o0_we <= (~builder_interface2_bank_bus_we);
	end
end
always @(*) begin
	main_i_status <= 2'd0;
	main_i_status[0] <= main_fields_i_gpio_0;
	main_i_status[1] <= main_fields_i_gpio_1;
end
assign builder_csrbank2_i_w = main_i_status[1:0];
assign main_i_we = builder_csrbank2_i_we;
assign main_fields_oe_gpio_0 = main_oe_storage[0];
assign main_fields_oe_gpio_1 = main_oe_storage[1];
assign builder_csrbank2_oe0_w = main_oe_storage[1:0];
assign main_fields_o_gpio_0 = main_o_storage[0];
assign main_fields_o_gpio_1 = main_o_storage[1];
assign builder_csrbank2_o0_w = main_o_storage[1:0];
assign builder_csrbank3_sel = (builder_interface3_bank_bus_adr[13:9] == 1'd0);
assign builder_csrbank3_enable0_r = builder_interface3_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank3_enable0_we <= 1'd0;
	builder_csrbank3_enable0_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank3_enable0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_enable0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_width0_r = builder_interface3_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank3_width0_re <= 1'd0;
	builder_csrbank3_width0_we <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 1'd1))) begin
		builder_csrbank3_width0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_width0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_period0_r = builder_interface3_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csrbank3_period0_we <= 1'd0;
	builder_csrbank3_period0_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csrbank3_period0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_period0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_enable0_w = main_pwm_enable_storage;
assign builder_csrbank3_width0_w = main_pwm_width_storage[31:0];
assign builder_csrbank3_period0_w = main_pwm_period_storage[31:0];
...
always @(posedge sys_clk_1) begin
	...
	if (builder_csrbank2_sel) begin
		case (builder_interface2_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface2_bank_bus_dat_r <= builder_csrbank2_i_w;
			end
			1'd1: begin
				builder_interface2_bank_bus_dat_r <= builder_csrbank2_oe0_w;
			end
			2'd2: begin
				builder_interface2_bank_bus_dat_r <= builder_csrbank2_o0_w;
			end
		endcase
	end
	main_i_re <= builder_csrbank2_i_re;
	if (builder_csrbank2_oe0_re) begin
		main_oe_storage[1:0] <= builder_csrbank2_oe0_r;
	end
	main_oe_re <= builder_csrbank2_oe0_re;
	if (builder_csrbank2_o0_re) begin
		main_o_storage[1:0] <= builder_csrbank2_o0_r;
	end
	main_o_re <= builder_csrbank2_o0_re;
	builder_interface3_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank3_sel) begin
		case (builder_interface3_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_enable0_w;
			end
			1'd1: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_width0_w;
			end
			2'd2: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_period0_w;
			end
		endcase
	end
	if (builder_csrbank3_enable0_re) begin
		main_pwm_enable_storage <= builder_csrbank3_enable0_r;
	end
	main_pwm_enable_re <= builder_csrbank3_enable0_re;
	if (builder_csrbank3_width0_re) begin
		main_pwm_width_storage[31:0] <= builder_csrbank3_width0_r;
	end
	main_pwm_width_re <= builder_csrbank3_width0_re;
	if (builder_csrbank3_period0_re) begin
		main_pwm_period_storage[31:0] <= builder_csrbank3_period0_r;
	end
	main_pwm_period_re <= builder_csrbank3_period0_re;
	if (sys_rst_1) begin
		main_i_re <= 1'd0;
		main_oe_storage <= 2'd0;
		main_oe_re <= 1'd0;
		main_o_storage <= 2'd0;
		main_o_re <= 1'd0;
...
assign gpio_gpio_0 = main_tstriple0_oe ? main_tstriple0_o : 1'bz;
assign main_tstriple0_i = gpio_gpio_0;

assign gpio_gpio_1 = main_tstriple1_oe ? main_tstriple1_o : 1'bz;
assign main_tstriple1_i = gpio_gpio_1;
