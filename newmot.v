...
reg [15:0] main_qei_next_cnt = 16'd0;
...
assign main_qei_a = main_qei_a_f[0];
assign main_qei_b = main_qei_b_f[0];
assign main_qei_i = main_qei_i_f[0];
...
assign builder_slave_sel = (builder_shared_adr[29:14] == 14'd12288);
...
always @(posedge sys_clk_1) begin
	...
	case ({main_qei_a_f[1:0], main_qei_b_f[1:0]})
		1'd1: begin
			main_qei_next_cnt <= (main_qei_cnt + 1'd1);
		end
		2'd2: begin
			main_qei_next_cnt <= (main_qei_cnt - 1'd1);
		end
