...
/* gpio */
#define CSR_GPIO_BASE (CSR_BASE + 0x1800L)
#define CSR_GPIO_I_ADDR (CSR_BASE + 0x1800L)
#define CSR_GPIO_I_SIZE 1
static inline uint32_t gpio_i_read(void) {
	return csr_read_simple(CSR_BASE + 0x1800L);
}
#define CSR_GPIO_I_GPIO_0_OFFSET 0
#define CSR_GPIO_I_GPIO_0_SIZE 1
static inline uint32_t gpio_i_gpio_0_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t gpio_i_gpio_0_read(void) {
	uint32_t word = gpio_i_read();
	return gpio_i_gpio_0_extract(word);
}
#define CSR_GPIO_I_GPIO_1_OFFSET 1
#define CSR_GPIO_I_GPIO_1_SIZE 1
static inline uint32_t gpio_i_gpio_1_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 1) & mask );
}
static inline uint32_t gpio_i_gpio_1_read(void) {
	uint32_t word = gpio_i_read();
	return gpio_i_gpio_1_extract(word);
}
#define CSR_GPIO_OE_ADDR (CSR_BASE + 0x1804L)
...
#define CSR_GPIO_OE_GPIO_0_OFFSET 0
#define CSR_GPIO_OE_GPIO_0_SIZE 1
static inline uint32_t gpio_oe_gpio_0_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t gpio_oe_gpio_0_read(void) {
	uint32_t word = gpio_oe_read();
	return gpio_oe_gpio_0_extract(word);
}
static inline uint32_t gpio_oe_gpio_0_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void gpio_oe_gpio_0_write(uint32_t plain_value) {
	uint32_t oldword = gpio_oe_read();
	uint32_t newword = gpio_oe_gpio_0_replace(oldword, plain_value);
	gpio_oe_write(newword);
}
#define CSR_GPIO_OE_GPIO_1_OFFSET 1
#define CSR_GPIO_OE_GPIO_1_SIZE 1
static inline uint32_t gpio_oe_gpio_1_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 1) & mask );
}
static inline uint32_t gpio_oe_gpio_1_read(void) {
	uint32_t word = gpio_oe_read();
	return gpio_oe_gpio_1_extract(word);
}
static inline uint32_t gpio_oe_gpio_1_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 1))) | (mask & plain_value)<< 1 ;
}
static inline void gpio_oe_gpio_1_write(uint32_t plain_value) {
	uint32_t oldword = gpio_oe_read();
	uint32_t newword = gpio_oe_gpio_1_replace(oldword, plain_value);
	gpio_oe_write(newword);
}
#define CSR_GPIO_O_ADDR (CSR_BASE + 0x1808L)
#define CSR_GPIO_O_SIZE 1
static inline uint32_t gpio_o_read(void) {
	return csr_read_simple(CSR_BASE + 0x1808L);
}
static inline void gpio_o_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1808L);
}
#define CSR_GPIO_O_GPIO_0_OFFSET 0
#define CSR_GPIO_O_GPIO_0_SIZE 1
static inline uint32_t gpio_o_gpio_0_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t gpio_o_gpio_0_read(void) {
	uint32_t word = gpio_o_read();
	return gpio_o_gpio_0_extract(word);
}
static inline uint32_t gpio_o_gpio_0_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void gpio_o_gpio_0_write(uint32_t plain_value) {
	uint32_t oldword = gpio_o_read();
	uint32_t newword = gpio_o_gpio_0_replace(oldword, plain_value);
	gpio_o_write(newword);
}
#define CSR_GPIO_O_GPIO_1_OFFSET 1
#define CSR_GPIO_O_GPIO_1_SIZE 1
static inline uint32_t gpio_o_gpio_1_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 1) & mask );
}
static inline uint32_t gpio_o_gpio_1_read(void) {
	uint32_t word = gpio_o_read();
	return gpio_o_gpio_1_extract(word);
}
static inline uint32_t gpio_o_gpio_1_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 1))) | (mask & plain_value)<< 1 ;
}
static inline void gpio_o_gpio_1_write(uint32_t plain_value) {
	uint32_t oldword = gpio_o_read();
	uint32_t newword = gpio_o_gpio_1_replace(oldword, plain_value);
	gpio_o_write(newword);
}
